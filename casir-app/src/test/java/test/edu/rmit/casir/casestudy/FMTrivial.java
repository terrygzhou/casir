...
public class FMTrivial {
	static Logger logger = Logger.getLogger(FMTrivial.class);
	...
	String rec1RawData = "./casestudy/epca/" + name + "_rec1_raw.txt";
...
//			component.setComposedLPCA(new CompositeLPCA(localLPCAVec));
		});
	...
	public void testConfiguration() {
		this.conf.print();
		CompositeLPCA gloLPCA = this.conf.getGloModel();
		logger.info(gloLPCA.getGlobalPCA().getComposite().getLTS());
	}
...
//		global_rec1_com.getTraces(10000, this.createSample(), this.createTimeCostMap(),
//				this.createDollarCostMap(), this.rec1RawData);
	}
...
//		String prismModel = this.comVpca.convertVPCAToDTMC();
